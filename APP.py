...
# === Load model ===
model = joblib.load(r"C:\Users\kisho\OneDrive\Music\Desktop\abc\forecasting_ev_model.pkl")
...
# Image
st.image(r"C:\Users\kisho\OneDrive\Music\Desktop\abc\ev-car-factory.jpg", use_container_width=True)
...
@st.cache_data
def load_data():
    df = pd.read_csv(r"C:\Users\kisho\OneDrive\Music\Desktop\jupyter note\preprocessed_ev_data.csv")
...
ax.set_facecolor("#523890")
fig.patch.set_facecolor("#7f8e89")
